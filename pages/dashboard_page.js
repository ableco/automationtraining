...
export default class DashboardPage {
    constructor() {
        this.addInvestmentButton = Selector('.u-displayInlineBlock.DropdownButton .Button--secondary').child('span').withText('Add New...');
        this.newHoldingButton = Selector('.DropdownMenu .DropdownMenuItem .DropdownMenuItem-anchor').withText('New Holding');
