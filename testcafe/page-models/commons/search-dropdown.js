...
class SearchResults{
    constructor(selector, type){
        this.title = selector.find(".SearchBoxResultGroup .SearchBoxResultGroup-title").withText(type);
        this.optionList = selector.find(".SearchBoxResultGroup .SearchBoxResultGroup-title").nextSibling("div").find("a")
    }
}
...
export default class SearchDropdown{
    ...
    async selectOption (option, type){
        ...
        await t
            .click(results.optionList.withText(option), { visibilityCheck: true })
    }
}