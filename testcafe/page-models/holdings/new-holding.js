...
export default class NewHolding{
    constructor(){
        ...
        this.portfolio = new Dropdown(modal.find('div[name="FormElement--portfolio"]'));
        ...
        //Footer
        this.addholdingButton = Selector('.FullScreenModalFooter button').withText('Add Holding');
        this.cancelButton = Selector('.FullScreenModalFooter button').withText('Cancel');
    ...
    async addNewEquityWithMandatoryFields(type, amount, series, name, acquisitionDate, price, sharesNumber){
        await t
            .click(this.holdingList.withExactText(type), { visibilityCheck: true });
        ...
        await t
            .typeText(this.newEquity.customNameInput, name);
        ...
        await t
            .typeText(this.newEquity.sharesNumberInput, sharesNumber);
