...
fixture('Investment Tests')
    ...
    test ('Remove Investment', async t => {
        await t
           ...
           .click(newInvestmentPage.viewInvestment)

           .wait(5000)
           .click(newInvestmentPage.actionsMenu)
           .click(newInvestmentPage.deleteOption)

           .wait(1000)
           .click(newInvestmentPage.removeButton)
           
       
            .expect(newInvestmentPage.message.textContent).eql('Holding successfully deleted');
